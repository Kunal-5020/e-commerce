        ...
        <div className="container mx-auto p-8 min-h-screen">
            <div className="flex flex-col md:flex-row gap-8 bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="md:w-1/2">
                    <img src={mainImage} alt={product.name} className="w-full h-96 object-contain rounded-lg mb-4 shadow-md" />
                    <div className="flex space-x-2 overflow-x-auto">
                        {product.images.map((img, index) => (
                            <img
                                ...
                                src={img.url}
                                alt={img.altText}
                                className="w-20 h-20 object-cover rounded-md cursor-pointer border-2 border-transparent hover:border-blue-500 transition duration-200"
                ...
                <div className="md:w-1/2">
                        ...
                        <div className="mb-4">
                            ...
                            <div className="flex space-x-2">
                                {product.colors.map(color => (
                                    <div
                                        key={color.hexCode}
                                        className={`w-8 h-8 rounded-full cursor-pointer border-2 ${selectedColor && selectedColor.hexCode === color.hexCode ? 'border-blue-500' : 'border-gray-300'}`}
                    ...
                    <div className="mt-8 border-t border-gray-200 pt-6">
                        ...
                        <ul className="list-disc list-inside text-gray-700 space-y-2">
                            ...
                            {product.dimensions && <li><strong>Dimensions:</strong> {product.dimensions.length}x{product.dimensions.width}x{product.dimensions.height} cm</li>}
